              ...
              delegate: SliverChildListDelegate(
                [
                  ...
                  TextFormField(
                    ...
                    validator: (value) => TextFormValidation.fullNameValidation(
                        value,
                        context: context),
                    onTapOutside: (_) =>
                  ...
                  TextFormField(
                    style: CustomTheme.textFieldTextStyle,
                    validator: (value) => TextFormValidation.optionalEmailValidation(
                        value,
                        context: context),
                    onTapOutside: (_) =>
                        FocusScope.of(context).requestFocus(FocusNode()),
                    ...
                    decoration: InputDecoration(
                      hintText: "${AppLocalizations.of(context)?.emailOption}",
                    ),
                  ),
                ],
              ),
                      ...
                      onPressed: () {
                        ...
                        if (filledFormCorrectly) {
                          context.read<EditProfileBloc>().add(
                              EditProfileEvent.editUserProfile(
                                  context: context,
                                  name: name.text,
                                  email: email.text,
                               ));
